...
if __name__ == "__main__":
    ...
    # Adjust paths if running directly
    vid_in = 'Vids/406_1.mp4'
    csv_in = 'RunVideo406/mots/cam1_mapped.csv'
    vid_out = 'RunVideo406/videos/cam1_tracked.mp4'
    
    create_annotated_video(vid_in, csv_in, vid_out)